...
export const AM_CONTENT: LandingContent = {
  ...
  ai: {
    eyebrow: "AI የተጎለበተ የትምህርት ቤት ድጋፍ",
    title: "AI ተግባራዊ የሚሆንበት",
    titleHighlight: "መምህራን፣ ተማሪዎች እና አመራር",
    lead: "AI በ EduSync SMS ድጋፍ ነው — መምህራንን መተካት አይደለም። መምህራን በፍጥነት እቅድ ይሰራሉ፣ ተማሪዎች የተመራ የመማሪያ እገዛ ያገኛሉ፣ አመራር ወርሃዊ ሪፖርት ይፈጥራሉ፣ ሰራተኞች ለወላጆች ግልጽ ረቂቆች ይጽፋሉ። ከመላክ በፊት ቡድንዎ ሁልጊዜ ይገምግማል።",
    capabilities: [
      {
        title: "AI የመማሪያ ተጋሩ",
        description:
          "ለተማሪዎች የተመራ ማብራሪያ፣ የመማሪያ እገዛ እና በአውድ የተማረ መማሪያ ውይይት።",
      },
      {
        title: "AI የትምህርት እቅድ",
        description:
          "በክፍል እና በትምህርት መምሪያ ዓላማዎች፣ እንቅስቃሴዎች እና ግምገማዎች — ከመማር በፊት ያርትዑ።",
      },
      {
        title: "የአፈጻጸም ትንተና",
        description:
          "ውጤት እና ቅጥያ ተጣምረው አደጋ ላይ ሊወድቁ የሚችሉ ተማሪዎችን በቅድሚያ ያብራራሉ።",
      },
      {
        title: "AI ወርሃዊ ሪፖርት",
        description:
          "ምዝገባ፣ ትምህርት፣ ቅጥያ፣ ፋይናንስ እና ቅርንጫፍ አፈጻጸም በአንድ ለአመራር ማጠቃለያ።",
      },
      {
        title: "ዘመናዊ የወላጅ መልዕክት",
        description:
          "ለእድገት፣ ቅጥያ ማስጠንቀቂያ እና ክፍያ ማስታወሻ — በእንግሊዝኛ እና በአማርኛ ረቂቆች።",
      },
    ],
  },
  tools: {
  ...
  modules: {
    ...
    items: [
      ...
      },
      {
        id: "ai",
        title: "AI",
        description: "ለተማሪዎች፣ መምህራን እና አመራር አማራጭ ረዳቶች",
        items: [
          "AI የመማሪያ ተጋሩ",
          "AI የትምህርት እቅድ",
          "የአፈጻጸም ትንተና እና አደጋ ምልክቶች",
          "AI ወርሃዊ የአመራር ሪፖርት",
  ...
  pricing: {
    ...
    lead: "በመስመር ይመዝገቡ — Starter የመጀመሪያውን አንድ ወር ነፃ በተማሪ 30 ብር/ወር። ሙሉ AI ድጋፍ ለ Growth በተማሪ 50 ብር/ወር።",
    recommended: "የሚመከር",
    plans: [
      {
        name: "Starter",
      ...
      {
        name: "Growth",
        tagline: "AI ያለው ብዙ ቅርንጫፍ ትምህርት ቤቶች",
        price: "50 ብር",
        priceNote: "በተማሪ / ወር · AI ተካትቷል",
        highlighted: true,
        ctaHref: "/register/school",
        features: [
          "በ Starter ውስጥ ያለው ሁሉ",
