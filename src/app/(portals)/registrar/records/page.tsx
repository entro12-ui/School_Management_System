      ...
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-slate-500">
            All registered users with email, one-time password, and details — including
            registrars and HR Managers after approval. Search, filter, sort, update, or
            deactivate accounts. Pending applications are under{" "}
